                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							...
							{		
                                    ...
                                    echo  '<li class="nav-item"><a href="admin/index.php" class="nav-link active">Contact Us</a> </li>';
                                    echo  '<li class="nav-item"><a href="admin/index.php" class="nav-link active">About Us</a> </li>';
